...
The exposed curved shell stays solid throughout movement. Its material uses the original silver rail's measured color (approximately RGB121/121/123) with subtle grain sampled from that rail. A separate fixed strip of the original hinge photograph covers the seam while the grille rotates, preventing the hidden dirt plate from showing through the joint.
