...
test('favorites, friend sharing, and canonical track links stay exact and responsive', async ({ page }) => {
  ...
  for (const viewport of [
    { width: 1240, height: 960, minimumMapHeight: 460, actionRows: 1, maximumLayoutHeight: 900 },
    { width: 1280, height: 960, minimumMapHeight: 460, actionRows: 1, maximumLayoutHeight: 900 },
    { width: 1366, height: 960, minimumMapHeight: 460, actionRows: 1, maximumLayoutHeight: 900 },
    { width: 1439, height: 960, minimumMapHeight: 460, actionRows: 1, maximumLayoutHeight: 900 },
    { width: 1519, height: 960, minimumMapHeight: 460, actionRows: 1, maximumLayoutHeight: 900 },
