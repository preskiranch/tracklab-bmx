...
export function useMultiplayer({
  ...
  return {
    ...
    cancelMatchmaking,
    startStudioMatch,
    joinStudentRoom: (activityType: 'bmx-race' | 'straight-sprint') => send({ type: 'club-student-join', activityType }),
    confirmStudentChoice: (setup: MultiplayerRaceSetup) => send({ type: 'club-student-choice', setup }),
    resetStudentRoom: () => send({ type: 'club-student-reset' }),
    setRoomReady,
    startRoomRace,
