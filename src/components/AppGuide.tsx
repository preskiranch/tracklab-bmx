  ...
  return (
    <section className="app-guide" aria-label={beta ? 'Beta Testing Info guide' : 'App Guide'}>
      <div className="app-guide-intro">
        ...
        <p>{beta
          ? 'Set up your invitation, connect your Wattbike, and put TrackLab through its paces. This guide includes the full feature tour, what to test, and how access works after beta.'
      ...
      <div className="app-guide-access" aria-label="Access at a glance">
        ...
        <article><span>02 / Invited beta</span><h3>Bring your Wattbike.</h3><p>Your invitation unlocks a set number of simultaneous bike connections for a limited testing period. No purchase is required to activate that beta access.</p></article>
      ...
      {billingReady === false && <p className="app-guide-availability"><strong>Purchase availability:</strong> Apple billing is being configured. Purchase and Restore are currently unavailable; invited beta access works without checkout.</p>}
