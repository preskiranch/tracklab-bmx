export const commentaryResearchMetadata = Object.freeze({
  ...
  method: 'aggregate-caption-terminology-audio-prosody-and-event-driven-broadcast-flow',
  ...
  coverageCutoff: '2026-07-23',
  indexedVideos: 285,
  indexedEventsByYear: Object.freeze({ 2024: 50, 2025: 29, 2026: 20 }),
...
const eventDelivery = Object.freeze({
  ...
  'race-update': 'Bridge the live action naturally from the current course phase, running order, and tightest battle. Keep the call moving without inventing a pass or resetting the whole race.',
